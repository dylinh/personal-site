    ...
    return (
        <div className="about-page fade-in">
            ...
            <div className="blog-card-container">
                <ProjectCard desc="A responsive, mobile-first, and accessible personal website." date="September 18, 2025" title="dylinh.com" tags={["Typescript", "React", "Frontend"]} path="https://github.com/dylinh/personal-site" />
